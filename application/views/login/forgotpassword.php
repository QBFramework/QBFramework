...
<md-input-container md-no-float class="md-block">
    ...
    <div layout="row">
    <md-button class="md-raised md-warn" flex="100" ng-click="postData()" type="submit">Login</md-button>
    </div>
    <div layout="row">
    ...
    <a ui-sref='change_password' class="md-primary md-button md-ink-ripple">Having problems logging in? forgot.</a>
    </div>
