...
class index extends Controller
	{
		...
		public function recharge()
		{
			...
			$rechargeinfo=array(
				'RechargePeopleId'=>$_POST['udf1'],
				'Amt'=>$_POST['amount'],
				'Status'=>'1'
			);
			$this->index_model->insert('recharge',$rechargeinfo);
			if($_POST['udf3'])
			{	
				$walletinfo=array(
			...
			$this->mailer->message($payu['firstname'].' '.$payu['lastname'].' '."you have recharge succesfully");
			$this->mailer->send();
			$this->payu($_POST);
			$info['val']=1;
